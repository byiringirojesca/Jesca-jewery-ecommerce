...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,300&family=Satoshi:wght@300;400;500;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        body {
            ...
            /* luxury-white fallback */
            color: #0D0D0D;
            /* luxury-black fallback */
            overflow-x: hidden;
        }
...
<body class="font-sans antialiased min-h-screen flex flex-col selection:bg-[#D4AF37] selection:text-[#0D0D0D]">
    ...
    <main class="flex-grow">
        ...
        @else
            ...
            <section class="min-h-screen relative w-full flex items-center bg-[#F3EFE9]/40 pt-24 overflow-hidden">
                <div
                    class="w-full max-w-[1800px] mx-auto px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">

                    <div
                        class="lg:col-span-5 order-2 lg:order-1 flex flex-col justify-center transform translate-y-0 opacity-100 duration-1000 transition-all">
                        <span class="text-xs uppercase tracking-[0.5em] text-[#D4AF37] mb-6 font-medium block">Autumn /
                            Winter Edition</span>
                        <h1
                            class="text-5xl lg:text-7xl xl:text-8xl font-serif font-light text-[#0D0D0D] leading-[1.05] tracking-tight mb-8">
                        ...
                        <p class="text-sm lg:text-base font-light text-[#1A1A1A] leading-relaxed max-w-md mb-12">
                            Sculpted architecture worn next to skin. Handcrafted fine gems paired with unstructured raw
                            textiles for the modern academic curator.
                        </p>
                        <div>
                            <a href="{{ route('products.index') }}"
                                class="inline-flex items-center group relative text-xs uppercase tracking-[0.3em] font-medium py-3 pr-8 text-[#0D0D0D] overflow-hidden">
                                <span class="relative z-10">Enter The Atelier</span>
                                <span
                                    class="absolute bottom-0 left-0 w-full h-[1px] bg-[#0D0D0D] transition-transform origin-right scale-x-100 group-hover:scale-x-0"></span>
                                <span
                                    class="absolute bottom-0 left-0 w-full h-[1px] bg-[#D4AF37] transition-transform origin-left scale-x-0 group-hover:scale-x-100"></span>
                                <svg class="w-4 h-4 ml-2 transform transition-transform group-hover:translate-x-2 absolute right-0"
                    ...
                    <div
                        class="lg:col-span-7 order-1 lg:order-2 relative w-full h-[50vh] lg:h-[80vh] bg-[#F3EFE9] overflow-hidden group border border-neutral-200/40">
                        ...
                        <div
                            class="absolute bottom-6 left-6 z-20 text-white font-serif italic text-lg tracking-widest opacity-80">
                            Objêt d'Art n° 041
                        </div>
                    </div>
                </div>
            ...
            <section class="py-32 lg:py-48 w-full bg-[#FAF8F5]">
                <div class="max-w-[1800px] mx-auto px-6 lg:px-16">
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-24 w-full">
                        <div class="max-w-2xl">
                            <span class="text-xs uppercase tracking-[0.5em] text-[#D4AF37] mb-4 block">// 01 Curated
                                Works</span>
                            <h2 class="text-4xl lg:text-6xl font-serif font-light tracking-tight text-[#0D0D0D]">The
                                Signature Curation</h2>
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-start">
                        ...
                        <div class="lg:col-span-5 lg:mt-24 flex flex-col">
                            <div
                                class="bg-[#F3EFE9] overflow-hidden relative group aspect-[3/4] mb-8 border border-neutral-100">
                                <img src="https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?q=80&w=800"
                                    alt="Fine Jewelry Collection"
                                    class="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000" />
                                <div
                                    class="absolute inset-0 bg-[#0D0D0D]/10 opacity-0 group-hover:opacity-100 transition-opacity">
                                </div>
                            </div>
            ...
            <section class="py-24 bg-[#0D0D0D] text-[#FAF8F5] relative overflow-hidden">
                <div
                    class="absolute inset-0 opacity-10 pointer-events-none mix-blend-overlay bg-[radial-gradient(#FAF8F5_1px,transparent_1px)] [background-size:16px_16px]">
                </div>
                <div class="max-w-5xl mx-auto px-6 text-center py-16">
                    <span class="text-xs uppercase tracking-[0.6em] text-[#D4AF37] mb-8 block font-light">The
                        Philosophy</span>
                    <p
                        class="font-serif font-light text-2xl lg:text-5xl italic leading-relaxed text-[#F3EFE9] tracking-wide">
                        "Luxury is not noticed through excess. It is felt through the profound clarity of empty space, heavy
                        weight, and deliberate execution."
                    </p>
    ...
    <footer class="bg-[#0D0D0D] text-[#FAF8F5] pt-24 pb-12 border-t border-[#1A1A1A] mt-auto">
        <div class="max-w-[1800px] mx-auto px-6 lg:px-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-[#1A1A1A]">
                ...
                <div class="lg:col-span-2">
                    ...
                    <p class="text-xs font-light text-neutral-400 max-w-sm leading-relaxed tracking-wide">
                        An academic thesis project reimagined as a premium, architectural boutique experience.
                        Engineered cleanly for the high-end design discipline.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-xs font-light text-neutral-400 tracking-wider">
                        <li><a href="{{ route('home') }}" class="hover:text-white transition-colors">Home Archive</a>
                        </li>
                        <li><a href="{{ route('products.index') }}" class="hover:text-white transition-colors">All
                                Ready-To-Wear</a></li>
                        <li><a href="{{ route('cart.index') }}" class="hover:text-white transition-colors">Your Order
                                Bag</a></li>
                    </ul>
                </div>

                <div>
                    <span class="text-[10px] uppercase tracking-[0.4em] text-[#D4AF37] block mb-6">Engine
                        Specifications</span>
                    <ul class="space-y-3 text-xs font-light text-neutral-400 tracking-wider">
                ...
                <div x-data="{ email: '', completed: false }">
                    <span class="text-[10px] uppercase tracking-[0.4em] text-[#D4AF37] block mb-6">Mailing
                        Gazette</span>

                    <!-- Form Frame View -->
                    <template x-if="!completed">
                        <form @submit.prevent="if(email.trim() !== '') completed = true"
                            class="relative flex items-center border-b border-neutral-700 focus-within:border-[#D4AF37] transition-colors py-1">
                            <input type="email" x-model="email" placeholder="Enter Email" required
                                class="bg-transparent border-none text-xs text-[#FAF8F5] placeholder-neutral-700 focus:outline-none w-full tracking-widest" />
                            <button type="submit"
                                class="text-[#D4AF37] text-xs uppercase tracking-widest pl-2 hover:text-white transition-colors">Join</button>
                        </form>
                    </template>
            ...
            <div
                class="pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] uppercase tracking-[0.3em] text-neutral-500 font-light">
